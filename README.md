...
# General Hand Book — Ministering
**Harare Zimbabwe South Stake** | Unit Level | Date: 13 April 2026
> Focus: Causes & Generations
...
flowchart TD
    ...
    ASGN["Assigned Families
    ┌──┐ ┌──┐ ┌──┐
    │👨‍👩‍👧│ │👨‍👩‍👧│ │👨‍👩‍👧│
    └──┘ └──┘ └──┘"]

    RSPRES["RS Presidents
    ┌──┐ ┌──┐ ┌──┐
    │👥│ │👥│ │👥│
    └──┘ └──┘ └──┘"]

    LSPRES["LS Presidents →
    Inform Ward Council + LCR"]

    ALLPRES["EQ Presidents / All Presidents
    ┌──┬──┬──┐
    │👥│👥│👥│
    ├──┼──┼──┤
    │👥│👥│👥│
...
| Node | Role |
|------|------|
| **Bishop** | Presides over unit (MV / Assist) |
| **EQ President** | Elders Quorum — bidirectional link with Bishop |
| **RS President** | Relief Society — receives delegation from Bishop |
| **Ministerials** | Assigned ministerial brothers (companions) |
| **Counselor** | Responsible for Ministering 2nd |
| **EQ Presidents + Companions** | Conduct interviews with assigned families |
| **Assigned Families** | Families receiving ministering |
| **RS Presidents → LS Presidents** | Report to Ward Council + LCR |
| **All Presidents** | Coordinate overall Ministering |
